...
namespace Wartorn {
	namespace Utility {
		...
		public static class ExtensionMethod {
			...
			public static bool IsLand(this TerrainType t) {
				switch (t) {
			...
			public static bool IsTraversable(this MovementType movementType, TerrainType terrainType) {
				bool isLandTraversable = terrainType.IsLand();
				bool isInfantryTraversable = (isLandTraversable && terrainType != TerrainType.Cliff) || terrainType == TerrainType.River;
				bool isTireTraversable = isLandTraversable && terrainType != TerrainType.Cliff && terrainType != TerrainType.Mountain;
				bool isTrackTraversable = isTireTraversable && terrainType != TerrainType.Forest;
				switch (movementType) {
					case MovementType.Air:
						return true;

					case MovementType.Soldier:
					case MovementType.Mech:
						return isInfantryTraversable;

					case MovementType.Tires:
						return isTireTraversable;

					case MovementType.Track:
						return isTrackTraversable;

					case MovementType.Ship:
					case MovementType.Lander:
						return !isLandTraversable;
