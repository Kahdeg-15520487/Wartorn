...
namespace Wartorn.Screens {
	...
	class EditorScreen : Screen {
		...
		private void RotateThroughTerrain(KeyboardState keyboardInputState) {
			...
			if ((HelperFunction.IsKeyPress(Keys.D1) && !isQuickRotate)
				|| (keyboardInputState.IsKeyDown(Keys.D1) && isQuickRotate)) {
			...
			if ((HelperFunction.IsKeyPress(Keys.D2) && !isQuickRotate)
				|| (keyboardInputState.IsKeyDown(Keys.D2) && isQuickRotate)) {
